...
function MinhasReservas() {
  ...
  useEffect(() => {
    // Buscar reservas
    fetch('https://dual-klara-hotel-brasileiro-eaecb8d3.koyeb.app/api/reservas/minhas-reservas', {
      headers: {
    ...
    fetch('https://dual-klara-hotel-brasileiro-eaecb8d3.koyeb.app/api/clientes/me', {
      headers: {
        Authorization: authHeader
      }
    })
      ...
      .then(data => {
        if (data && data.success && data.data) {
          ...
          if (data.data.ft_perfil) {
            setProfilePicUrl(`https://dual-klara-hotel-brasileiro-eaecb8d3.koyeb.app/${data.data.ft_perfil}`);
          } else {
  ...
  async function confirmarExclusao() {
    if (reservaSelecionada) {
      await fetch(`https://dual-klara-hotel-brasileiro-eaecb8d3.koyeb.app/api/reservas/${reservaSelecionada.reserva_id}`, {
        method: 'DELETE',
        headers: {
          Authorization: authHeader
        }
  ...
  async function handleEditSubmit(e) {
    ...
    try {
      const response = await fetch(`https://dual-klara-hotel-brasileiro-eaecb8d3.koyeb.app/api/clientes/${userId}`, {
        method: 'PUT',
        headers: {
      ...
      if (profilePicFile && userId) {
        ...
        await fetch(`https://dual-klara-hotel-brasileiro-eaecb8d3.koyeb.app/api/clientes/${userId}/ft_perfil`, {
          method: 'PUT',
          headers: {
            Authorization: authHeader
          },

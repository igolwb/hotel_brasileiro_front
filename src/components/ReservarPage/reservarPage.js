...
const handlePaymentCheckout = async () => {
  ...
  try {
    const response = await fetch('https://hotel-brasileiro-back.onrender.com/api/reservas/criar-e-pagar', {
      method: 'POST',
      headers: {
    ...
    if (response.ok && data.checkoutUrl) {
      ...
      setMensagemErro(data.message || 'Erro ao iniciar o pagamento.');
    }
  } catch (error) {
    console.error('Erro ao iniciar o pagamento:', error);
    setMensagemErro('Erro ao iniciar o pagamento.');
  }
};

...
const experiences = [
  ...
  },
  {
    ...
    time: "16h00 – 18h00",
    description:
      "Uma jornada baseada em uma pergunta que você nos fizer ao chegar. Exemplo: “O que há no pé das pedras?” A resposta virá em forma de trilha, jantar e um objeto misterioso.",
  },
  {
    image: hora3,
    ...
    time: "11h30 – 12h30",
    description:
      "Deite-se na rede suspensa sobre o rio e deixe que o vento escute o indivíduo. Opções: “Grande Serão-Vertedouro” sussurrado, passeio de Manoel de Barro, código Morse, ou o canto das cigarras em loop infinito.",
  },
  {
    image: hora4,
            ...
            {rooms.map((room) => (
              <div className="room-card" key={room.id}>
                ...
                <div className="room-info">
                  <h3>{room.nome}</h3>
                  <p>{room.descricao}</p>
                  <Link to={`/reserva/${room.id}`} className="reserve-btn">
                    Detalhes
                  </Link>
                </div>
              </div>

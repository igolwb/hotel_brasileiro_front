...
function CadastroPage() {
  ...
  return React.createElement("div", { className: "container" }, [
    React.createElement("div", { className: "left-panel" }, [
      React.createElement("div", { className: "logo-title-row" }, [
        React.createElement(
          "div",
          { className: "logo" },
          React.createElement("img", { className: "logo-img-login", src: logo, alt: "Logo" }),
        ),
        React.createElement("h1", null, ["Hotel ", React.createElement("br"), " Brasileiro"]),
      ]),
      ...
      React.createElement(
        ...
        isMobile
          ...
          : "Só precisamos de duas coisas: seu email e sua vontade de relaxar.",
      ),
    ]),
    React.createElement(
      "div",
      ...
      React.createElement("form", { className: "login-form", onSubmit: handleSubmit }, [
        ...
        React.createElement("div", { style: { display: "flex", alignItems: "center", position: "relative" } }, [
          React.createElement("input", {
            ...
            style: {
              flex: 1,
              ...(passwordRequirements.every((r) => r.test(form.senha)) || !form.senha ? {} : { borderColor: "red" }),
            },
          }),
        ...
        React.createElement("div", { style: { display: "flex", alignItems: "center", position: "relative" } }, [
          React.createElement("input", {
            ...
            style: {
              flex: 1,
              ...(form.confirmSenha && form.senha !== form.confirmSenha ? { borderColor: "red" } : {}),
            },
          }),
          React.createElement("img", {
        ...
        showPasswordRequirements &&
          form.senha &&
          passwordRequirements.some((r) => !r.test(form.senha)) &&
          React.createElement(
            "ul",
        ...
        success &&
          React.createElement("div", { style: { color: "green", margin: "8px 0", textAlign: "center" } }, success),
        React.createElement(
          "button",
